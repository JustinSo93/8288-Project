...
public static void main(String[] args) {
	...
	ConcertSeason currentSeason = new ConcertSeason(null, null, null);
	ScheduledConcert aChristmasCarol = new ScheduledConcert(null, null, null, null, null);
	SymphonyController test = new SymphonyController();
	test.
	
/**
 * this is where I"ve left off.  I'm messing around with putting everything that was in testmain into the controller addConcert method.  The singleton 
 * thing is screwing me up too.  
 */
...
//SymphonyController test = new SymphonyController();
//
//ConcertSeason currentSeason = new ConcertSeason(null, new Date(1,1,2016), new Date (1,1,2017));
//
//test.getSymphonyControllerSingletonInstance(null);
////addConcert currentSeason, aChristmasCarol;
